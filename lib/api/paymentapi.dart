...
Future<void> makePayments(String phoneNumber, double total) async{
  ...
  try{
    ...
    final checkoutRequestId = await initiatePayment(accessToken: accessToken, phoneNumber: phonenumber, amount: amount, referenceNumber: referenceNumber);
    print('Payment Initiated $checkoutRequestId',);
  }catch(e){
